...
public interface NwpErrorCodes {
    ...
    String NWP_LLM_CONTEXT_NOT_FOUND = "NWP-LLM-CONTEXT-NOT-FOUND";
    String NWP_LLM_CONTEXT_EXPIRED = "NWP-LLM-CONTEXT-EXPIRED";
    String NWP_LLM_CONTEXT_VERSION_CONFLICT = "NWP-LLM-CONTEXT-VERSION-CONFLICT";
    String NWP_LLM_CONTEXT_BINDING_MISMATCH = "NWP-LLM-CONTEXT-BINDING-MISMATCH";
    String NWP_LLM_CONTEXT_FORBIDDEN = "NWP-LLM-CONTEXT-FORBIDDEN";
    String NWP_LLM_CONTEXT_LIMIT_EXCEEDED = "NWP-LLM-CONTEXT-LIMIT-EXCEEDED";
    String NWP_LLM_CONTEXT_OPERATION_UNSUPPORTED = "NWP-LLM-CONTEXT-OPERATION-UNSUPPORTED";
    ...
    String NWP_HTTP_ORIGIN_FORBIDDEN          = "NWP-HTTP-ORIGIN-FORBIDDEN";
    String NWP_HTTP_CONTENT_TYPE_UNSUPPORTED  = "NWP-HTTP-CONTENT-TYPE-UNSUPPORTED";
    ...
    Map<String, String> NWP_TO_NPS_STATUS = Map.ofEntries(
        ...
        Map.entry(NWP_LLM_CONTEXT_NOT_FOUND,       NpsStatusCodes.NPS_CLIENT_NOT_FOUND),
        Map.entry(NWP_LLM_CONTEXT_EXPIRED,         NpsStatusCodes.NPS_CLIENT_GONE),
        Map.entry(NWP_LLM_CONTEXT_VERSION_CONFLICT,NpsStatusCodes.NPS_CLIENT_CONFLICT),
        Map.entry(NWP_LLM_CONTEXT_BINDING_MISMATCH,NpsStatusCodes.NPS_CLIENT_CONFLICT),
        Map.entry(NWP_LLM_CONTEXT_FORBIDDEN,       NpsStatusCodes.NPS_AUTH_FORBIDDEN),
        Map.entry(NWP_LLM_CONTEXT_LIMIT_EXCEEDED,  NpsStatusCodes.NPS_LIMIT_RESOURCE),
        Map.entry(NWP_LLM_CONTEXT_OPERATION_UNSUPPORTED, NpsStatusCodes.NPS_SERVER_UNSUPPORTED),
        ...
        Map.entry(NWP_HTTP_ORIGIN_FORBIDDEN,       NpsStatusCodes.NPS_AUTH_FORBIDDEN),
        Map.entry(NWP_HTTP_CONTENT_TYPE_UNSUPPORTED,NpsStatusCodes.NPS_CLIENT_BAD_FRAME),
